...
function zoomOnPC(){
	var imgsList = document.querySelectorAll(".post-content img:not(.link-avatar)");//CSS选择器，选择非link-avatar的图片
	var popup = document.getElementById("popup");
	for(var i = 0; i < imgsList.length; i++){
		imgsList[i].onclick = function (event){
	...
	popup.getElementsByClassName("bg")[0].setAttribute("onmousewheel","return bigByMouseWheel(this);");
...
/*Fork from https://github.com/onlyhom/touch-scale-img .Something wrong is fixed by iyzyi.*/
...
(function(window, undefined){
	...
	ImagesZoom.prototype = {
		...
		init: function(param){
			...
			var imgList   = document.querySelectorAll(params.elem + " img:not(.link-avatar)"),
				//linkBoxImgList = document.querySelectorAll(params.elem, "img"),
			...
			for(var len=imgList.length,i=0; i<len; i++){
				imgList[i].addEventListener("click", function(){
					...
					zoomImg.onload = function(){
						...
						// 禁止页面滚动
						document.addEventListener("touchmove", self.eventStop, { passive: false });//改动了第三个参数
		...
		_close: function(){
			...
			var zoomMask  = document.querySelector(".imgscale-pack"),
				...
				self._destroy();
				document.removeEventListener("touchmove", self.eventStop, { passive: false });//改动了第三个参数
		},
		...
		_touchend: function(e){
			...
			if(self.basePageX == getPage(e, "pageX") && self.basePageY == getPage(e, "pageY")){
				//console.log('单击');
				self._close();
				return false;
			}
		...
		getTouchDist: function(e){
			...
			y1 = e.touches[0].pageY - (document.body.scrollTop + document.documentElement.scrollTop);//改动了此处
			y2 = e.touches[1].pageY - (document.body.scrollTop + document.documentElement.scrollTop);//改动了此处
